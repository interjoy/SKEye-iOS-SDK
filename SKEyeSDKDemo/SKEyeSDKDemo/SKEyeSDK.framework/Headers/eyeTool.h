 ...
 * 回调方式
 **/
+ (void)SKEyeSDK_Image:(UIImage *)image service_name:(SK_SERVICE_NAME*)server_name callBack:(void(^)(id responseObject))callBack;

/*
 * 上传本地路径或者URL指向图片
 * 回调方式
 **/
+ (void)SKEyeSDK_ImagePath:(NSString *)imagePath service_name:(SK_SERVICE_NAME*)server_name callBack:(void(^)(id responseObject))callBack;

/*
 * 上传图片数据
 * 非回调方式
 **/
+ (NSData *)SKEyeSDK_Image:(UIImage *)image service_name:(SK_SERVICE_NAME*)server_name;

/*
 * 上传本地路径或者URL指向图片
 * 非回调方式
 **/
+ (NSData *)SKEyeSDK_ImagePath:(NSString *)imagePath service_name:(SK_SERVICE_NAME*)server_name;
